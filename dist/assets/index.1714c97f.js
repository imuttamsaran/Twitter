const c=function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))e(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&e(i)}).observe(document,{childList:!0,subtree:!0});function t(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerpolicy&&(l.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?l.credentials="include":s.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function e(s){if(s.ep)return;s.ep=!0;const l=t(s);fetch(s.href,l)}};c();document.querySelector("#app").innerHTML=`
            ...
            <div class="m-4">
                <div class=" flex">
                    ...
                    <div class="w-full">
                        ...
                        <div class="m-2">
                            <p class="text-lg">HOLY SHIT!!!!! \u{1F929}\u{1F929}
                                <br>
                                ...
                                Twitter finally paid off. \u{1F389}\u{1F38A}\u{1F973} <br>
                    ...
                    <div class="w-full">
                        ...
                        <div class="m-2">
                            <p class="text-lg">Thanks for reading this thread \u2764
                                ...
                                <br>
                                \u{1F537}Like the tweet <br>
                                \u{1F537}Retweet the first tweet\u26A1
                                <br>
            ...
            <div class="m-4">
                <div class=" flex">
                    ...
                    <div class="w-full">
                        ...
                        <div class="m-2">
                            <p class="text-lg">Not my setup \u{1F62C} but it's super cool \u2728
                                <br>
            ...
            <div class="m-4">
                <div class=" flex">
                    ...
                    <div class="w-full">
                        <div class="flex justify-between items-center">
                            <div class=" mx-2">
                                <span class="">selemonjrdev\u{1F680}</span>
                        ...
                        <div class="m-2">
                            <p class="text-lg">That's all for today \u263A. <br>
                                ...
                                Follow me for such great content \u{1F48E}
                            </p>
                        </div>
                        <div class="">
                        <div class="post-comment flex justify-between mt-2 items-center p-2">
